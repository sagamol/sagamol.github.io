...
const patscherkofelkoor = [47.2086, 11.4606];
...
let patscherkofelMarker = L.marker(patscherkofelkoor).addTo(markerGroup);

patscherkofelMarker.bindPopup("<p>Patscherkofel von der Nordkette aus</p><img style='width:200px' src='https://apps.tirol.gv.at/luft/nordkette.jpg' alt='Patscherkofl' />");


let redLine = L.polyline([igls, patscherkofelkoor], {
    color : 'red'
});
myMap.addLayer(redLine);
